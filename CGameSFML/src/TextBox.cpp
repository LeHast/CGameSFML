...
hast::Textbox::Textbox(int l_visible, int l_charSize, int l_width, sf::Vector2f l_screenPos) {
...
void hast::Textbox::Setup(int l_visible, int l_charSize, int l_width, sf::Vector2f l_screenPos){
	...
	m_content.setFillColor(sf::Color(255,255,255,255));
...
void hast::Textbox::Add(std::string l_message) {
...
void hast::Textbox::Clear() { 
	m_messages.clear();
}


void hast::Textbox::Render(sf::RenderWindow& l_wind) {
